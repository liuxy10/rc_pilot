...
static double linear_map[][2] = {{0.0, 0.0000}, {0.1, 0.1000}, {0.2, 0.2000}, {0.3, 0.3000},
    {0.4, 0.4000}, {0.5, 0.5000}, {0.6, 0.6000}, {0.7, 0.7000}, {0.8, 0.8000}, {0.9, 0.9000},
    {1.0, 1.0000}};
...
static double mn1806_1400kv_4s_map[][2] = {{0.0, 0.0000}, {0.1, 0.2982}, {0.2, 0.6310},
    {0.3, 1.0281}, {0.4, 1.5224}, {0.5, 2.0310}, {0.6, 2.5791}, {0.7, 3.1365}, {0.8, 3.7282},
    {0.9, 4.3147}, {1.0, 4.7258}};
...
static double f20_2300kv_2s_map[][2] = {{0.00, 0.000000}, {0.05, 6.892067}, {0.10, 12.57954},
    {0.15, 18.84790}, {0.20, 26.16294}, {0.25, 33.98255}, {0.30, 41.60790}, {0.35, 49.32732},
    {0.40, 58.27048}, {0.45, 67.83613}, {0.50, 78.20817}, {0.55, 88.27728}, {0.60, 100.1058},
    {0.65, 110.3643}, {0.70, 121.6316}, {0.75, 132.2155}, {0.80, 145.0420}, {0.85, 154.6838},
    {0.90, 162.0185}, {0.95, 168.4321}, {1.00, 177.1643}};
...
static double rx2206_4s_map[][2] = {{0.0, 0.00000000000000}, {0.05, 17.8844719758775},
...
static double tosky2212_4s_map[][2] = {{0.0, 0.00}, {0.1, 0.03907893918}, {0.2, 0.08761681004}, {0.3, 0.1377908596},
...
// normalize the thrust to [0,1] (xinyi)
static const int tosky2212_4s_points = 16;
static double Tosky2212_4s_map[][2] = {{0.000, 0.000}, {0.06666667, 0.0368758689}, {0.13333333,0.0725917706}, {0.2,0.1174712397},
        {0.26666667, 0.1672406345},{0.33333333, 0.2153309351}, {0.4, 0.2608609408}, {0.46666667,0.313206197},
        {0.53333333, 0.3900531134}, {0.6, 0.4762246032}, {0.66666667, 0.56394889}, {0.73333333, 0.6602469808}, 
        {0.8, 0.7721605475}, {0.86666667, 0.8617445003}, {0.93333333, 0.9998819981}, {1.000 , 1.000}};
>>>>>>> 7aba4bfcdf164c6b5f4c0a9f2b00340f3fca8165
